...
class DeleteLocationEmployee
{
    use AsAction;

    public function handle(string $location_employee_id): bool
    {
        LocationEmployeeAggregate::retrieve($location_employee_id)->delete()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('LocationEmployee.delete', LocationEmployee::class);
    }
    ...
    {
        Alert::success("LocationEmployee was deleted")->flash();
