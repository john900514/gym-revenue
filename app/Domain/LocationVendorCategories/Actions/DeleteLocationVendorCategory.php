...
class DeleteLocationVendorCategory
{
    use AsAction;

    public function handle(LocationVendorCategory $location_vendor_category): bool
    {
        LocationVendorCategoryAggregate::retrieve($location_vendor_category->id)->delete()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('locationVendorCategorys.delete', LocationVendorCategory::class);
    }
    ...
    {
        Alert::success("LocationVendorCategory '{$location_vendor_category->name}' was deleted")->flash();
