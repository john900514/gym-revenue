...
class TrashLocationVendorCategory
{
    use AsAction;

    public function handle(LocationVendorCategory $location_vendor_category): LocationVendorCategory
    {
        LocationVendorCategoryAggregate::retrieve($location_vendor_category->id)->trash()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('locationVendorCategorys.trash', LocationVendorCategory::class);
    }
    ...
    {
        Alert::success("LocationVendorCategory '{$location_vendor_category->name}' sent to trash")->flash();
