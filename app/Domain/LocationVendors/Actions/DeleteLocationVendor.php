...
class DeleteLocationVendor
{
    use AsAction;

    public function handle(LocationVendor $location_vendor): bool
    {
        LocationVendorAggregate::retrieve($location_vendor->id)->delete()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('locationVendors.delete', LocationVendor::class);
    }
    ...
    {
        Alert::success("Vendor '{$location_vendor->name}' was deleted")->flash();
