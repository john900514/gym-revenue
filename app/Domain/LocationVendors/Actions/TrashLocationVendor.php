...
class TrashLocationVendor
{
    use AsAction;

    public function handle(LocationVendor $location_vendor): LocationVendor
    {
        LocationVendorAggregate::retrieve($location_vendor->id)->trash()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('locationVendors.trash', LocationVendor::class);
    }
    ...
    {
        Alert::success("Vendor '{$location_vendor->poc_name}' sent to trash")->flash();
