...
class DeleteStructuredDocumentRequest
{
    use AsAction;

    public function handle(string $structured_document_request_id): bool
    {
        StructuredDocumentRequestAggregate::retrieve($structured_document_request_id)->delete()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('structured-document-request.delete', StructuredDocumentRequest::class);
    }
    ...
    {
        Alert::success("Structured document request was deleted")->flash();
