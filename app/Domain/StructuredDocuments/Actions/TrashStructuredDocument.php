...
class TrashStructuredDocument
{
    use AsAction;

    public function handle(string $structured_document_id): bool
    {
        StructuredDocumentAggregate::retrieve($structured_document_id)->trash()->persist();
    ...
    public function authorize(ActionRequest $request): bool
    {
        ...
        return $current_user->can('structured-documents.trash', StructuredDocument::class);
    }
    ...
    {
        Alert::success("Structured document sent to trash")->flash();
