...
{
    public function onTrialMembershipTypeUpdated(TrialMembershipTypeUpdated $event): void
    {
    ...
    public function onTrialMembershipTypeCreated(TrialMembershipTypeCreated $event): void
    {
