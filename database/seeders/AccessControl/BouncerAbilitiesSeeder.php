...
class BouncerAbilitiesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $crud_models = collect([
            ...
            'email-templates', 'scheduled-campaigns', 'drip-campaigns', 'client',
        ]);
        ...
        foreach ($clients as $client) {
            ...
            $this->allowReadInGroup([
                ...
                'calendar', 'roles', 'classifications', 'access_tokens', 'drip-campaigns', 'scheduled-campaigns', 'client',
            ], 'Account Owner', $client);
            $this->allowEditInGroup([
                'users', 'locations', 'leads', 'lead-statuses', 'lead-sources', 'members', 'files', 'teams', 'calendar',
                'roles', 'classifications', 'access_tokens', 'drip-campaigns', 'scheduled-campaigns', 'client',
            ], 'Account Owner', $client);
