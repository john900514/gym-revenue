    ...
    <header class="hidden lg:flex justify-between items-center py-4 px-6 bg-base-300 border-b border-base-100">
        ...
        <div class="flex items-center">
            <div class="relative mr-4 lg:mx-0">
                ...
                <input
                    class="form-input w-32 sm:w-64 rounded-md pl-10 pr-4 p-2 bg-base-100 border-1 border-transparent focus:bg-transparent focus:border-primary"
        ...
        <div class="flex items-center">
            <!-- Notifications -->
            <div class="relative">
                <button @click="showingNotificationDropdown = ! showingNotificationDropdown"
                ...
                <div v-show="showingNotificationDropdown" @click="showingNotificationDropdown = false"
                ...
                <div v-show="showingNotificationDropdown"
                    ...
                    <a href="#" class="flex items-center px-4 py-3  hover:bg-base-100 -mx-2">
                        ...
                        <p class="text-sm mx-2 w-full">
                            <span class="font-bold" href="#">Sara Salah</span> replied on the <span class="font-bold ">Upload Image</span>
                            article. 2m
                        </p>
                    </a>
                    <a href="#" class="flex items-center px-4 py-3  hover:bg-base-100 -mx-2">
                    ...
                    <a href="#" class="flex items-center px-4 py-3  hover:bg-base-100 -mx-2">
                        ...
                        <p class="text-sm mx-2 w-full">
                            <span class="font-bold" href="#">Jane Doe</span> Like Your reply on <span class="font-bold "
                                                                                                      href="#">Test with TDD</span>
                            artical . 1h
                        </p>
                    </a>
                    <a href="#" class="flex items-center px-4 py-3  hover:bg-base-100 -mx-2">
            ...
            <div class="relative">
                <button v-if="$page.props.jetstream.managesProfilePhotos"
                        ...
                        class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-base-100-300 transition duration-150 ease-in-out">
                ...
                <div v-show="showingUserDropdown" @click="showingUserDropdown = false"
                     class="fixed inset-0 h-full w-full z-10" style="display: none;"></div>
                ...
                <div v-show="showingUserDropdown"
                    ...
                    <template v-if="$page.props.jetstream.hasTeamFeatures">
                        ...
                        <inertia-link :href="route('teams.show', $page.props.user.current_team)"
                                      class="block px-4 py-2 text-sm  hover:bg-base-100">Team Settings
                        </inertia-link>
                        <inertia-link :href="route('teams.create')" v-if="$page.props.jetstream.canCreateTeams"
                                      class="block px-4 py-2 text-sm  hover:bg-base-100">Create New Team
                        </inertia-link>
                        ...
                        <template v-for="team in $page.props.user.all_teams" :key="team.id">
                            <form @submit.prevent="switchToTeam(team)">
                                <button
                                    class="block px-4 py-2 text-sm leading-5  hover:bg-base-100 focus:outline-none focus:bg-base-100 transition duration-150 ease-in-out w-full">
                                    <div class="flex items-center">
                    ...
                    <inertia-link :href="route('profile.show')" class="block px-4 py-2 text-sm  hover:bg-base-100">
                        Profile
                    </inertia-link>

                    <inertia-link :href="route('api-tokens.index')" v-if="$page.props.jetstream.hasApiFeatures"
                                  class="block px-4 py-2 text-sm  hover:bg-base-100">API Tokens
                    </inertia-link>

                    <!--                        <form @submit.prevent="logout">-->
                    <button @click="logout" type="submit"
                            class="block px-4 py-2 text-sm  hover:bg-base-100 w-full text-left focus:outline-none">
                        Log Out
                    </button>
                    <!--                    </form>-->
                </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        return {showingNotificationDropdown, showingUserDropdown, logout, switchToTeam};
    },
});
</script>
