<template>
    <header
        class="hidden lg:flex justify-between items-center py-4 px-6 bg-base-300 border-b border-base-100"
    >
        <!-- Searchbar -->
        ...
        <div class="flex items-center">
            ...
            <div class="relative">
                ...
                >
                    <a
                        href="#"
                        class="flex items-center px-4 py-3 hover:bg-base-100 -mx-2"
                    >
                        <figure class="w-1/6">
                            <img
                ...
                >
                    <template v-if="$page.props.jetstream.hasTeamFeatures">
                        ...
                        <inertia-link
                            ...
                            "
                            class="block px-4 py-2 text-sm hover:bg-base-100"
                            >Team Settings
                        </inertia-link>
                        <inertia-link
