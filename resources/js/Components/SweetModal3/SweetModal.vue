...
<script>
	export default {
		...
		mounted() {
			this.tabs = this.$slots.default().filter(c => c.cmpName && c.cmpName == 'tab')
...
<style lang="scss">
    @import '~sweet-modal-vue/src/styles/mixins';
	@import '~sweet-modal-vue/src/styles/colors';
	@import '~sweet-modal-vue/src/styles/animations';
	@import '~sweet-modal-vue/src/styles/icons';
