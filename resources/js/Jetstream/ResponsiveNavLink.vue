        ...
        computed: {
            classes() {
                return this.active
                    ...
                    : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium  hover:bg-base-100 hover:border-gray-300 focus:outline-none focus: focus:bg-base-100 focus:border-gray-300 transition'
            }
        }
    })
</script>
