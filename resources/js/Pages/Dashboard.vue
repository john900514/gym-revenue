<template>
    <app-layout>
        <template #header>
            ...
            <div class="flex flex-row justify-center pb-4" v-if="(announcements.length > 0) && showAnnouncement">
                ...
                <div class="flex-1 flex-col">
                    ...
                    <br />
                    <ul>
                        <li v-for="(note, x) in announcements[0].notes" v-show="x < 3"> * {{ note }}</li>
                    </ul>
                    ...
                    <div class="flex flex-row pt-6 ml-4">
                        ...
                        <button type="button" @click="showAnnouncement = false" class="pr-4 text-white hover:text-error"><label class="uppercase" style="letter-spacing: 0.1em;font-weight: 600;cursor:pointer;">Close Me</label></button>
                    </div>
                </div>
