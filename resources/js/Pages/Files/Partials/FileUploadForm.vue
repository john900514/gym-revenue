<template>
    <jet-form-section @submitted="handleSubmit">
        ...
        <template #form>
            ...
            <!--                />-->
            <!--            </div>-->
            <section class="col-span-6 pt-10 md:py-16 lg:py-24 overflow-hidden">
                <div
                    class="max-w-screen-xl mx-auto text-center px-4 sm:px-6 lg:px-8"
                >
                    <div class="max-w-3xl mx-auto lg:max-w-none">
                        <div
                            class="mt-6 sm:mt-5 sm:grid sm:grid-cols-1 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5"
                        >
                            <div class="mt-2 sm:mt-0 sm:col-span-2">
                                ...
                                >
                                    <div
                                        class="absolute rounded-full h-20 w-20 z-10 transition-opacity duration-500 ease-in-out"
                                        :class="{
                                            'opacity-100':
                                                uploadDragoverTracking,
                                            'opacity-0':
                                                !uploadDragoverTracking,
                                        }"
                                    ></div>
                                    <div class="relative z-20 text-center">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">
                                            .csv, .json, .txt, .shp, .shx, .dbf,
                                            .nc and .tiff up to 10GB
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul class="shadow overflow-hidden sm:rounded-md mt-5">
                        <li v-for="(file, index) in form.files" :key="index">
                            <a
                                href="#"
                                class="block hover focus:outline-none focus:bg-base-100 transition duration-150 ease-in-out"
                            >
                                <div class="px-4 py-4 sm:px-6">
                                    ...
                                    >
                                        <div
                                            class="text-sm leading-5 font-medium text-secondary truncate"
                                        >
                                            {{ file.name }} ({{
        ...
        <template #actions>
            ...
            <button
                ...
                :class="{ 'opacity-25': form.processing }"
                :disabled="form?.files?.length < 1 || form.processing"
...
export default {
    ...
    setup(props, context) {
        ...
        const onUploadDropEvent = (e) => {
            console.log("onUploadDropEvent", e);
        ...
        const handleDroppedFiles = (e) => {
            console.log("handleDroppedFiles", e);
