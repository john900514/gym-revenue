    ...
    setup(props) {
        ...
        const actions = {
            ...
            contact: {
                ...
                shouldRender: ({data}) => {
                    const claimed = data.details_desc.filter(detail => detail.field === 'claimed');
        ...
        return {handleClickTrash, confirmTrash, handleConfirmTrash, fields, actions, Inertia, comingSoon};
    },
});
</script>
