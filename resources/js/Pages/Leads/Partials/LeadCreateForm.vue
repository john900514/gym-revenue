    ...
    <jet-form-section @submitted="handleSubmit">
        <template #form>
            ...
            <div class="col-span-4">
                ...
                <select class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" v-model="form['gr_location_id']" required>
        ...
        <template #actions>
            ...
            <div class="flex-grow" />
            <jet-button :class="{ 'opacity-25': form.processing }" class="btn-secondary" :disabled="form.processing"  :loading="form.processing">
                {{ buttonText }}
            </jet-button>
        </template>
    </jet-form-section>
