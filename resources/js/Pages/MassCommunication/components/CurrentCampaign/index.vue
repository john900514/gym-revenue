...
import DeploymentDays from "./DeploymentDays";
...
const columns = [
    {
        field: "action",
        label: "Actions",
        renderer: (value) => h(CampaignAction, { action: value }),
    },
    {
        field: "subject",
        label: "Subject",
    ...
    {
        label: "Preview",
        renderer: (value) => h(Button, { size: "xs", secondary: true }, "View"),
    },
    {
        label: "Report",
