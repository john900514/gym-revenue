                ...
                <template v-if="$page.props.user.has_api_token">
                    ...
                    <jet-form-section v-else>
                        ...
                        <template #description>
                            View your Access Token! It will bo in the
                            Authorization header with a Bearer in front of it.
                        </template>
                        <template #form>
                            <div class="col-span-6 sm:col-span-4">
                                <label
                                    >Viewing API tokens in impersonation mode is
                                    not authorized.</label
                                >
                            </div>
                        </template>
                    </jet-form-section>
