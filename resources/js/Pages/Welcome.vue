<template>
    ...
    <div
        class="relative flex items-top justify-center min-h-screen bg-base-100 dark:bg-gray-900 sm:items-center sm:pt-0"
    >
        <div
            v-if="canLogin"
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                class="mt-8 bg-base-300 dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg"
            >
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div
                        class="p-6 border-t border-base-100 dark:border-base-100-700 md:border-t-0 md:border-l"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                    ...
                    <div
                        class="p-6 border-t border-base-100 dark:border-base-100-700"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                    ...
                    <div
                        class="p-6 border-t border-base-100 dark:border-base-100-700 md:border-l"
                    >
                        <div class="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <div
                                class="ml-4 text-lg leading-7 font-semibold dark:text-white"
                            >
                                Vibrant Ecosystem
                            </div>
                        </div>
